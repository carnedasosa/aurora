...
const hygienePoints = [
  { icon: '🧹', title: 'Pulizia ambiente', description: 'Il mio studio viene sanificato dopo ogni appuntamento per garantire un ambiente sempre pulito.' },
  { icon: '🔧', title: 'Sterilizzazione strumenti', description: 'Tutti gli strumenti vengono sterilizzati in autoclave seguendo i più rigorosi protocolli.' },
  { icon: '🧤', title: 'Materiali monouso', description: 'Lime, buffer e altri materiali di consumo sono sempre nuovi e personali per ogni cliente.' },
  { icon: '✅', title: 'Standard professionali', description: 'Rispetto scrupolosamente tutte le normative igienico-sanitarie del settore.' },
]
